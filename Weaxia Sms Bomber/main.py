...
while 1:
    ...
    {}by {}@Weaxia
    <============>
   Weaxia Tarafında Oluşturuldu Alırsanız Ananızı Sikerim
    <============>
    """.format(Fore.LIGHTCYAN_EX, len(servisler_sms), Style.RESET_ALL, Fore.LIGHTRED_EX))
    try:
        menu = (input(Fore.LIGHTMAGENTA_EX + " 1- SMS Gönder (Normal)\n\n 2- SMS Gönder (Allah Gibi)\n\n 3- Quit Atma Yeri\n\n" + Fore.LIGHTYELLOW_EX + " Seçimini Yaz: "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
    ...
    if menu == 1:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "Telefon numarasını başında '0' olmadan yazınız (Birden çoksa 'enter' tuşuna basınız): "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        tel_liste = []
        if tel_no == "": 
            system("cls||clear")
        ...
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "Telefon numarasını başında '0' olmadan yazınız: "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        try:
            int(tel_no)
            if len(tel_no) != 10:
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Enter Bas Gec '' tuşuna basın): "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
            if ("@" not in mail or ".com" not in mail) and mail != "":
                raise
        except:
